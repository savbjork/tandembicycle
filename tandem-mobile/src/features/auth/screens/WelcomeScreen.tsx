        ...
        <SafeAreaView className="flex-1 bg-surface-dim">
            <View className="flex-1 px-8 justify-between pt-20 pb-12">
                ...
                <View className="items-center">
                    ...
                    <Text className="text-5xl font-bold text-text mb-4 tracking-tighter">
                        Tandem
                    </Text>
                ...
                <View className="space-y-6">
                    <View className="flex-row items-center gap-4">
                        ...
                        <View className="flex-1">
                            ...
                            <Text className="text-text-secondary text-sm">Quantify and redistribute domestic labor fairly.</Text>
                        </View>
                    </View>
                    ...
                    <View className="flex-row items-center gap-4 mt-6">
                        ...
                        <View className="flex-1">
                            ...
                            <Text className="text-text-secondary text-sm">Move from "helping" to true partnership.</Text>
                        </View>
                    </View>
                </View>
