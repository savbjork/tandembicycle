  ...
  return (
    <View className="bg-surface rounded-xl p-5 mb-6 shadow-sm">
      <View className="flex-row justify-between items-start mb-4">
        <View>
          <Text className="text-base font-semibold text-text">Balance</Text>
          <Text className="text-[13px] text-text-secondary mt-0.5">{totalPoints} pts total</Text>
        </View>
      </View>
      ...
      <View className="flex-row justify-around">
        <View className="items-center">
          <Text className="text-2xl font-bold text-primary-600">{currentUserPoints}</Text>
          <Text className="text-[13px] text-text-secondary mt-1">{currentUser}</Text>
        </View>
        <View className="items-center">
          <Text className="text-2xl font-bold text-secondary-600">{partnerPoints}</Text>
          <Text className="text-[13px] text-text-secondary mt-1">{partner}</Text>
        </View>
      </View>
    </View>
  );
