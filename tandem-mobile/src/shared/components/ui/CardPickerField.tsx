...
import { View, Modal, TouchableOpacity, ScrollView, Platform, StatusBar } from 'react-native';
              ...
              filtered.map((option) => {
                ...
                return (
                  <TouchableOpacity
                    ...
                    activeOpacity={0.7}
                    className={`flex-row items-center justify-between px-4 py-4 mb-2 rounded-xl border ${
                      isSelected
