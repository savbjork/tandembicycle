 ...
 */
export const SaveButton: React.FC<HeaderButtonProps> = ({ label = 'Save', className, ...props }) => (
    <TouchableOpacity
 ...
 */
export const CancelButton: React.FC<HeaderButtonProps> = ({ label = 'Cancel', className, ...props }) => (
    <TouchableOpacity
 ...
 */
export const DoneButton: React.FC<HeaderButtonProps> = ({ label = 'Done', className, ...props }) => (
    <TouchableOpacity
        className={`bg-surface border border-primary-100 px-4 py-2 rounded-xl active:bg-primary-50 ${className ?? ''}`}
        {...props}
    >
 ...
 */
export const EditIconButton: React.FC<TouchableOpacityProps & { size?: number }> = ({ size = 20, className, ...props }) => (
 ...
 */
export const CloseButton: React.FC<TouchableOpacityProps & { size?: number }> = ({ size = 24, className, ...props }) => (
    <TouchableOpacity
